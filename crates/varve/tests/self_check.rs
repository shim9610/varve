...
use varve::{
    ...
    MatrixCommitKind, MatrixDimensionDescriptor, MatrixDimensions, MatrixKey, RecoveryPolicy,
    SelfTestStepStatus, VarveBlock, VarveDecode, VarveEncode, VarveMatrixBlock, WireType,
    varve_format,
};
